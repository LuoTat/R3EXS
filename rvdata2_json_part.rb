...
def to_json_Actors(actors)
    ...
    File.open("JSON_part/Actors.json", 'w') { |file| file.write(Oj.dump(actors_array, :indent => 4)) }
end
...
def to_json_Animations(animations)
    ...
    File.open("JSON_part/Animations.json", 'w') { |file| file.write(Oj.dump(animations_array, :indent => 4)) }
end
...
def to_json_Armors(armors)
    ...
    File.open("JSON_part/Armors.json", 'w') { |file| file.write(Oj.dump(armors_array, :indent => 4)) }
end
...
def to_json_Classes(klasses)
    ...
    File.open("JSON_part/Classes.json", 'w') { |file| file.write(Oj.dump(klasses_array, :indent => 4)) }
end
...
def to_json_CommonEvents(commonEvents)
    ...
    File.open("JSON_part/CommonEvents.json", 'w') { |file| file.write(Oj.dump(commonEvents_array, :indent => 4)) }
end
...
def to_json_Enemies(enemies)
    ...
    File.open("JSON_part/Enemies.json", 'w') { |file| file.write(Oj.dump(enemies_array, :indent => 4)) }
end
...
def to_json_Items(items)
    ...
    File.open("JSON_part/Items.json", 'w') { |file| file.write(Oj.dump(items_array, :indent => 4)) }
end
...
def to_json_Map(map, mapname)
    ...
    File.open("JSON_part/#{mapname}.json", 'w') { |file| file.write(Oj.dump(map_hash, :indent => 4)) }
end
...
def to_json_MapInfos(mapinfos)
    ...
    File.open("JSON_part/MapInfos.json", 'w') { |file| file.write(Oj.dump(mapinfos_array, :indent => 4)) }
end

def to_json_Scripts(scripts)
    FileUtils.mkdir_p('JSON_part/Scripts') unless Dir.exist?('JSON_part/Scripts')
    scripts_info = {}
    scripts.each_with_index do |script, index|
        scripts_info[index] = script[1]
        File.open("JSON_part/Scripts/#{sprintf('%03d', index)}.rb", 'w') { |file| file.write(Zlib::Inflate.inflate(script[2]).force_encoding('UTF-8')) }
    end
    File.open("JSON_part/Scripts/Scripts_info.json", 'w') { |file| file.write(Oj.dump(scripts_info, :indent => 4)) }
end
...
def to_json_Skills(skills)
    ...
    File.open("JSON_part/Skills.json", 'w') { |file| file.write(Oj.dump(skills_array, :indent => 4)) }
end
...
def to_json_States(states)
    ...
    File.open("JSON_part/States.json", 'w') { |file| file.write(Oj.dump(states_array, :indent => 4)) }
end
...
def to_json_System(system)
    ...
    File.open("JSON_part/System.json", 'w') { |file| file.write(Oj.dump(system_hash, :indent => 4)) }
end
...
def to_json_Tilesets(tilesets)
    ...
    File.open("JSON_part/Tilesets.json", 'w') { |file| file.write(Oj.dump(tilesets_array, :indent => 4)) }
end
...
def to_json_Troops(troops)
    ...
    File.open("JSON_part/Troops.json", 'w') { |file| file.write(Oj.dump(troops_array, :indent => 4)) }
end
...
def to_json_Weapons(weapons)
    ...
    File.open("JSON_part/Weapons.json", 'w') { |file| file.write(Oj.dump(weapons_array, :indent => 4)) }
end

FileUtils.mkdir_p('JSON_part') unless Dir.exist?('JSON_part')
[
    'Data/Actors.rvdata2',
